...
namespace Project.API.Controllers
{
            ...
            var authClaims = new List<Claim>
    {
        ...
        new Claim(JwtRegisteredClaimNames.Jti, Guid.NewGuid().ToString())
            ...
            // تدوين حدث تسجيل الدخول الفعلي في اللوج
            Serilog.Log.Information("User LOGIN: '{Username}' logged in at {Time}", user.UserName, DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture));
        ...
        public async Task<IActionResult> VerifyLogin2Fa([FromBody] VerifyLoginTwoFactorDto model)
        {
            ...
            // تدوين حدث تسجيل الدخول الفعلي في اللوج بعد التحقق الثنائي
            Serilog.Log.Information("User LOGIN: '{Username}' logged in at {Time}", user.UserName, DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture));
        ...
        public async Task<ActionResult<IEnumerable<UserListItemDto>>> GetAllUsers()
        {
            ...
            foreach (var u in usersList)
            {
                ...
                var isOnline = Project.API.Hubs.ChatConnectionManager.OnlineUsers.ContainsKey(u.Id);
        ...
        public IActionResult Logout()
        {
            ...
            // تدوين حدث تسجيل الخروج الفعلي في اللوج
            Serilog.Log.Information("User LOGOUT: '{Username}' logged out at {Time}", username, DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture));
